...
export async function POST(
  ...
  try {
    ...
    const resolved = typeof params?.then === 'function' ? await (params as Promise<{ token: string }>) : params
    ...
    const result = await TeamService.acceptInvitation(validated.data, req)
