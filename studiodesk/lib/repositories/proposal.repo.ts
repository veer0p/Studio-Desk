...
export const proposalRepo = {
  ...
  async getProposalById(supabase: SupabaseClient<Database>, proposalId: string, studioId: string) {
  ...
  async getProposalLineItems(supabase: SupabaseClient<Database>, proposalId: string) {
    const { data, error } = await supabase
  ...
  async getProposalByToken(supabase: SupabaseClient<Database>, token: string) {
    const { data, error } = await supabase
      .from('proposals')
      .select(`
        *,
  ...
  async createProposal(supabase: SupabaseClient<Database>, data: ProposalInsert) {
  ...
  async createLineItems(supabase: SupabaseClient<Database>, items: ProposalLineItemInsert[]) {
    const { data, error } = await supabase
      .from('proposal_line_items')
      .insert(items)
      .select()
  ...
  async deleteLineItems(supabase: SupabaseClient<Database>, proposalId: string) {
  ...
  async softDeleteProposal(supabase: SupabaseClient<Database>, proposalId: string, studioId: string) {
  ...
  async markProposalSent(supabase: SupabaseClient<Database>, proposalId: string) {
    const { data, error } = await supabase
      .from('proposals')
      .update({
        status: 'sent',
  ...
  async markProposalViewed(supabase: SupabaseClient<Database>, proposalId: string) {
    const { error } = await supabase
      .from('proposals')
      .update({
  ...
  async markProposalAccepted(supabase: SupabaseClient<Database>, proposalId: string) {
    const { data, error } = await supabase
      .from('proposals')
      .update({
        status: 'accepted',
  ...
  async markProposalRejected(supabase: SupabaseClient<Database>, proposalId: string, reason?: string) {
    const { error } = await supabase
      .from('proposals')
      .update({
        status: 'rejected',
  ...
  async checkExpiredProposals(supabase: SupabaseClient<Database>, studioId: string) {
    const { error } = await supabase
      .from('proposals')
      .update({
        status: 'expired',
