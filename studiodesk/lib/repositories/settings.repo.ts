...
export const settingsRepo = {
  ...
  async upsertStudioSettings(supabase: Db, studioId: string, data: Record<string, unknown>) {
  ...
  async updateIntegrations(supabase: Db, studioId: string, data: Record<string, unknown>) {
