...
export class BookingService {
  ...
  static async getBooking(supabase: SupabaseClient<Database>, bookingId: string, studioId: string) {
    const booking = await bookingRepo.getBookingById(supabase, bookingId, studioId)
    if (!booking) throw Errors.notFound('Booking')
    return booking
  }

  static async createBooking(supabase: SupabaseClient<Database>, studioId: string, input: unknown, actor_id?: string) {
  ...
  static async updateBooking(supabase: SupabaseClient<Database>, bookingId: string, studioId: string, input: unknown, actor_id?: string) {
  ...
  static async deleteBooking(supabase: SupabaseClient<Database>, bookingId: string, studioId: string, actor_id?: string) {
  ...
  static async updateStatus(supabase: SupabaseClient<Database>, bookingId: string, studioId: string, status: string, actor_id?: string) {
    const current = await bookingRepo.getBookingById(supabase, bookingId, studioId)
    if (!current) throw Errors.notFound('Booking')
  ...
  static async getActivityFeed(supabase: SupabaseClient<Database>, bookingId: string, studioId: string) {
