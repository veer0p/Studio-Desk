...
export const PackageService = {
  async getPackages(supabase: SupabaseClient<Database>, studioId: string): Promise<ServicePackage[]> {
  ...
  async getAddons(supabase: SupabaseClient<Database>, studioId: string): Promise<Addon[]> {
