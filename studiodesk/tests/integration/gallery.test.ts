...
describe('Gallery API Integration', () => {
  ...
  beforeEach(async () => {
    ...
    immichMock.getStudioImmichCredentials.mockResolvedValue({ apiKey: 'test-key', userId: 'compat:studio-a' })
    immichMock.createAlbum.mockResolvedValue({ id: 'album-1' })
    immichMock.createShareLink.mockResolvedValue({ id: 'share-1', key: 'k1', url: 'https://test.immich.app/share/1' })
    immichMock.uploadAsset.mockResolvedValue({ id: 'temp-asset-1', status: 'created' })
