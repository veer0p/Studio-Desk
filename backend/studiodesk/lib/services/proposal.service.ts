...
export const ProposalService = {
  async getProposals(supabase: any, studioId: string, params: any) {
  ...
  async deleteProposal(supabase: any, proposalId: string, studioId: string) {
  ...
  async viewProposal(supabase: any, token: string): Promise<PublicProposalView> {
