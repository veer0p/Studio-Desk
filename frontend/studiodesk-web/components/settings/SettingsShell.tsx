...
export function SettingsShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex-1 overflow-hidden bg-background flex flex-col h-full items-center">
      <div className="w-full max-w-6xl border-b border-border/40 bg-background/95 backdrop-blur shrink-0 px-6 py-6 md:px-8">
      ...
      <div className="flex-1 w-full max-w-6xl flex flex-col md:flex-row overflow-hidden relative">
        <aside className="w-full md:w-64 shrink-0 border-b md:border-b-0 md:border-r border-border/40 bg-muted/20 p-4 md:p-6 overflow-x-auto md:overflow-y-auto custom-scrollbar z-10">
          <SettingsNav />
        </aside>
